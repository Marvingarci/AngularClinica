...
export class VerPacienteComponent implements OnInit {
  ...
  citasPaciente: HistoriaSubsiguiente[];
  ...
  anadirCita() {
    ...
    const dialogRef = this.subsiguiente.open(HistoriaSubsiguiente1, { disableClose: true, width: "70%" });
    this.inven.id_historia_subsiguiente = this.id;
...
export class HistoriaSubsiguiente1 {
  ...
  constructor(private form: InventariosService,
    private dialogRef: MatDialogRef<HistoriaSubsiguiente1>,
    private mensaje: MatSnackBar,//para cerrar el dialogo desde la misma interfaz
  ...
  guardarCita() {
    ...
    if (this.formulario_cita.valid) {
      ...
      var cita: any = {
        'fecha': fechaCita,
        'paciente': this.form.id_historia_subsiguiente
      }
      ...
      // this.citaGuardar.siguiente_cita = this.fecha_cita.value;
  ...
  get fecha_cita() { return this.formulario_cita.get('fecha_cita') };
...
export class CambiarFoto {
  ...
  public guardar() {
    ...
    this.id = this.servicio.id_historia_subsiguiente;
